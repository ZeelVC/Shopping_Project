function validate(){
    ...
    var BEname = document.getElementById("Business_Entity_text").value;
    var Btype = document.getElementById("Business_Type_text").value;
    ...
    var cpt = document.getElemaentById("Confirm_Password_text").value;
    if(fname.length == 0){
    ...
    if(BEname.length == 0){
        alert("Please! Enter Yout Business Entity Name.");
        return false;
    }
    if(Btype.length == 0){
        alert("Pease! Enter your Business Type First to Proceed.");
        return false;
    }
    if(email.length == 0){
